...
If the user clicks on the map wher one or more overlapping layers are present, the identify panel opens. The panel provides the layers information, therefore the user can navigate different layers information through the **Next** button <img src="../img/button/next.jpg" class="ms-docbutton"/> and **Previous** button <img src="../img/button/style_editor_back_button.jpg" class="ms-docbutton"/> present in the top right corner of the Identify panel. 
